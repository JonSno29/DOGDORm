...
!(function (jQuery, ytp) {
  (jQuery.mbYTPlayer = {
                    ...
                    events: {
                      onReady: function (a) {
                        if (((YTPlayer.player = a.target), !YTPlayer.isReady)) {
                          ...
                          (b.time = YTPlayer.player.time),
                            YTPlayer.canTrigger && jQuery(YTPlayer).trigger(b);
                        }
                      },
    ...
    getDataFromAPI: function (a) {
      if (
        ((a.videoData = jQuery.mbStorage.get("YYTPlayer_data_" + a.videoID)),
        jQuery(a)
    ...
    playlist: function (a, b, c) {
      ...
      return (
        ...
        "function" == typeof c &&
          jQuery(e).on("YTPChanged", function () {
            c(e);
          }),
    ...
    pause: function () {
      var a = this.get(0),
        ...
        c = b.find(".mb_YTPPlaypause");
      return (
        c.html(jQuery.mbYTPlayer.controls.play), a.player.pauseVideo(), this
      );
    },
    seekTo: function (a) {
      var b = this.get(0);
